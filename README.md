...
## Math skills
```mathematical analysis```, ```advanced algebra```, ```numerical analysis```, ```probability theory```, ```mathematical statistics```, ```stochastic process```, ```information theory```,```convex optimization```
